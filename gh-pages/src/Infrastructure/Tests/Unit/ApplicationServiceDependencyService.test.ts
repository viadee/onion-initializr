...
import { AppServiceAppDependencyService } from '../../../Domain/Services/ApplicationServiceDependencyService';
import { ApplicationService } from '../../../Domain/Entities/ApplicationService';
import { DomainService } from '../../../Domain/Entities/DomainService';

describe('AppServiceAppDependencyService', () => {
  let service: AppServiceAppDependencyService;

  beforeEach(() => {
    service = new AppServiceAppDependencyService();
  });

  describe('pickDependencies', () => {
    describe('when initialized', () => {
      it('should create an instance of AppServiceAppDependencyService', () => {
        expect(service).to.be.instanceOf(AppServiceAppDependencyService);
      });
